  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4 border-b border-gray-200">
        ...
        <button className="pb-3 px-4 border-b-2 border-transparent text-gray-600 hover:text-gray-900">
          Pending (1)
        </button>
        <button className="pb-3 px-4 border-b-2 border-transparent text-gray-600 hover:text-gray-900">
          Confirmed (2)
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <ul className="space-y-1 text-sm text-gray-700">
          <li className="flex items-start gap-2">
            ...
            <span>Respond to booking requests within 24 hours</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-green-500 mt-0.5">•</span>
            <span>Payment is released 24 hours after check-in</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-green-500 mt-0.5">•</span>
            <span>Cancellations must be made 48 hours in advance</span>
          </li>
        </ul>
      </div>
    </div>
